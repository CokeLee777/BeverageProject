...
with open("forconnect9.txt", 'rt', encoding='UTF8') as f:
            x = list(f.readlines())
            xy_name = []
...
model.load_weights('bp_0518_checkpoint')
model.summary()
