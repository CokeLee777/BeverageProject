...
cam = cv.VideoWriter('sample_basic_r1_0428.avi',cv.VideoWriter_fourcc('D', 'I', 'V', 'X'),25,(640,480))
cap = cv.VideoCapture('sample_basic_r1_0427.avi')
...
while(True):
    if time.time()- start > 10:
        ...
        # connectandserver.server().server_connect()
        #  채민이가 서버 안켜줌
        start = time.time()
