...
while True:
    ...
    if num_frames < 60:
        ...
        if num_frames <= 59:
            cv2.putText(frame_copy, "WAIT! GETTING BACKGROUND AVG.", (200, 400), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,255,255), 2)
            img_pil = Image.fromarray(cv2.cvtColor(frame_copy, cv2.COLOR_BGR2RGB))
            draw = ImageDraw.Draw(img_pil)
            
            draw.text((200, 420),  " 이거 배경 화려하면, 안되던게 더 안됨!!! ", font=font, fill=(255,255,255,0))
