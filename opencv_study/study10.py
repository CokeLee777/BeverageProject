    ...
    for idx, centroid in enumerate(centroids):
        ...
        if  250 > height > 150:
            ...
            if 160 > width > 80:
                ...
                if 400>centerX >200:
                    if 200 >centerY >100:
                        cv.putText(img_color,'BP : COKE', (10, 80), cv.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1, lineType=cv.LINE_AA)
                    elif 300>centerY >200:
                        cv.putText(img_color,'BP : CIDER' , (10, 80), cv.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1, lineType=cv.LINE_AA)
                    else:
                        cv.putText(img_color,'BP : WATER' , (10, 80), cv.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1, lineType=cv.LINE_AA)
